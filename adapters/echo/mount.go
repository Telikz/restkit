...
func Mount(restkitApi *api.Api, prefix string, router *echo.Echo, metas []schema.RouteMeta) error {
	...
	if err != nil {
		return errors.New("extracting routes from echo router: " + err.Error())
	}
